# Getting help with weasel

Thanks for using weasel. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/weasel/issues) to make sure the 
